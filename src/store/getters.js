    ...
    if (Array.isArray(articles)) {
        articles.forEach((article) => {
            ...
            if (title.indexOf(keyword) !== -1 || content.indexOf(keyword) !== -1) {
                // url 时文章中没有的数据，结合 articleId 拼出完整的路径
                ...
                content = content.substr(1, 100).replace(regex, '<span class="highlight">$1</span>')
